...
public class PromotionEntity {
    ...
    public PromotionEntity(Long promotionId, String name, String content, String type, Long value, Long maxValue, Date startDatetime, Date endDatetime, String status, Long serviceId, Long userPromotionId) {
