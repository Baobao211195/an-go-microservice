...
public class BookingEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(bookingId, custId, driverId, bookingFrom, bookingTo, fee, discount, tax, totalFee, paymentType, userWalletId, userPromotionId, serviceId, status, startDatetime, endDatetime, bookingDatetime, bookingNotes, fromX, fromY, toX, toX, custToken, driverScheduleId, distance);
    }
}
