...
public class UserEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(userId, fullname, mobile, email, password, createDatetime, updateDatetime, x, y, status, avatar, type, rating, socialId, idNoFront, idNoBack, inviteCode, fcmToken, province);
    }
}
